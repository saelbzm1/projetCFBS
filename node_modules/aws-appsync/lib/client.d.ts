...
declare type CredentialsGetter = () => (Credentials | CredentialProvider | Promise<Credentials> | Promise<Credentials> | null) | Credentials | CredentialProvider | Promise<Credentials> | Promise<Credentials> | null;
